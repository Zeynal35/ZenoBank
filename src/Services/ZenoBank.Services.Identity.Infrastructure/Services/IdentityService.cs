...
public class IdentityService : IIdentityService
{
    ...
    {
        return Task.FromResult(Result<UserDto>.Failure("Register logic will be implemented next."));
    }

    public Task<Result<AuthResponse>> LoginAsync(LoginRequest request, CancellationToken cancellationToken = default)
    {
        return Task.FromResult(Result<AuthResponse>.Failure("Login logic will be implemented next."));
    }
    ...
    {
        return Task.FromResult(Result<AuthResponse>.Failure("Refresh token logic will be implemented next."));
    }

    public Task<Result> LogoutAsync(string refreshToken, CancellationToken cancellationToken = default)
    {
        return Task.FromResult(Result.Failure("Logout logic will be implemented next."));
    }

    public Task<Result> AssignRoleAsync(AssignRoleRequest request, CancellationToken cancellationToken = default)
    {
        return Task.FromResult(Result.Failure("Assign role logic will be implemented next."));
    }

    public Task<Result<UserDto>> GetCurrentUserAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        return Task.FromResult(Result<UserDto>.Failure("Get current user logic will be implemented next."));
    }
}
